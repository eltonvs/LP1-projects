...
int main(int argc, char const *argv[]) {
    ...
    //fl3 Forward_list<int> fl3(std::move(fl1));
    ...
    assert(fl1.size() == 0);
    assert(fl2.size() == 0);
    //fl3 assert(fl3.size() == 0);

    // Unity test #2: empty()
    assert(fl1.empty() == true);
    assert(fl2.empty() == true);
    //fl3 assert(fl3.empty() == true);
    ...
    //fl3 assert(fl3.back() == 10);      // back() to fl3
    ...
    //fl3 assert(fl3.front() == 10);     // front() to fl3
    assert(fl1.back() == 10);      // back() to fl1
    assert(fl2.back() == 10);      // back() to fl2
    //fl3 assert(fl3.back() == 10);      // back() to fl3
    ...
    //fl3 assert(fl3.size() == 0);      // size() to fl3
    assert(fl1.empty() == true);  // empty() to fl1
    assert(fl2.empty() == true);  // empty() to fl2
    //fl3 assert(fl3.empty() == true);  // empty() to fl3
    ...
    assert(i == 7);
    // To fl3
    //fl3 it = fl3.insert_after(fl3.before_begin(), 0);
    //fl3 for (it = fl3.begin(), i = 0; it != fl3.end(); ++it, i++) {
        //fl3 assert(fl3.front() == i);
        //fl3 fl3.pop_front();
    //fl3 }
    //fl3 assert(i == 7);
    ...
    // To fl3
    //fl3 it = fl3.insert_after(fl3.before_begin(), 0);
    //fl3 for (cit = fl3.cbegin(), i = 0; cit != fl3.cend(); cit++, i++) {
        //fl3 assert(fl3.front() == i);
        //fl3 fl3.pop_front();
    //fl3 }
    //fl3 assert(i == 7);
    ...
    //fl3 it = fl3.erase_after(fl3.cbefore_begin());
